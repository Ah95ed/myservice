...
// فئة لإدارة طلبات تليكرام خاصة
class TelegramService {
  static const String _baseUrl = AppConstants.telegramApiUrl;
  ...
  static Future<Map<String, dynamic>> sendMessage({
    ...
    final url = '$_baseUrl$botToken/sendMessage';
    
    return await NetworkService.post(url, {
      'chat_id': chatId,
      'text': message,
      'parse_mode': 'HTML',
    });
  ...
  static Future<Map<String, dynamic>> getUpdates({
    ...
    final url = '$_baseUrl$botToken/getUpdates';
    final queryParams = offset != null ? '?offset=$offset' : '';
    
    return await NetworkService.get('$url$queryParams');
  }
  ...
  static Future<Map<String, dynamic>> getChatInfo({
    ...
    final url = '$_baseUrl$botToken/getChat';
